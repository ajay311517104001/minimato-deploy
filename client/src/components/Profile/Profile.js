...
import EditProfile from '../EditProfileC/EditProfileC';
...
class Profile extends Component  {
    ...
    componentDidMount(){
        ...
        const reqOne = domain.get('http://localhost:5000/business/profile', {headers : {Authorization: token}});
        const reqTwo = domain.get('http://localhost:5000/business/getImage', {headers : {Authorization: token}});
...
//To handle cancel button
    ...
    onUpdate = (event) => {
        ...
        try {
            ...
            // } else {
                domain.put('http://localhost:5000/business/editprofile', {
                    id: id,
                    name: editName,
                    email: editEmail,
